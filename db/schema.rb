...
ActiveRecord::Schema[7.0].define(version: 2026_01_19_193504) do
  ...
  create_table "checkins", force: :cascade do |t|
    ...
    t.index ["habit_id", "occurred_on"], name: "index_checkins_on_habit_id_and_occurred_on", unique: true
    t.index ["habit_id"], name: "index_checkins_on_habit_id"
    t.index ["user_id", "occurred_on"], name: "index_checkins_on_user_id_and_occurred_on"
